...
#define AF_DRVNAME "FM50AF_GC5005"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x18
#define PLATFORM_DRIVER_NAME "lens_actuator_fm50af_gc5005"
#define AF_DRIVER_CLASS_NAME "actuatordrv_fm50af_gc5005"
...
////////////////////////////////////////////////////////////////
static long FM50AF_GC5005_Ioctl(
...
//CAM_RESET
static int FM50AF_GC5005_Open(struct inode * a_pstInode, struct file * a_pstFile)
{
    LOG_INF("Start \n");
...
static int FM50AF_GC5005_Release(struct inode * a_pstInode, struct file * a_pstFile)
{
    LOG_INF("Start \n");
...
{
    .owner = THIS_MODULE,
    .open = FM50AF_GC5005_Open,
    .release = FM50AF_GC5005_Release,
    .unlocked_ioctl = FM50AF_GC5005_Ioctl,
#ifdef CONFIG_COMPAT
    .compat_ioctl = FM50AF_GC5005_Ioctl,
#endif
};
...
static int FM50AF_GC5005_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id);
static int FM50AF_GC5005_i2c_remove(struct i2c_client *client);
static const struct i2c_device_id AF_i2c_id[] = {{AF_DRVNAME, 0},{}};
static struct i2c_driver FM50AF_GC5005_i2c_driver = {
    .probe = FM50AF_GC5005_i2c_probe,
    .remove = FM50AF_GC5005_i2c_remove,
...
static int FM50AF_GC5005_probe(struct platform_device *pdev)
{
    return i2c_add_driver(&FM50AF_GC5005_i2c_driver);
}

static int FM50AF_GC5005_remove(struct platform_device *pdev)
{
    i2c_del_driver(&FM50AF_GC5005_i2c_driver);
    return 0;
}

static int FM50AF_GC5005_suspend(struct platform_device *pdev, pm_message_t mesg)
{
    return 0;
}

static int FM50AF_GC5005_resume(struct platform_device *pdev)
{
    return 0;
}
...
static struct platform_driver g_stAF_Driver = {
    .probe        = FM50AF_GC5005_probe,
    .remove    = FM50AF_GC5005_remove,
    .suspend    = FM50AF_GC5005_suspend,
    .resume    = FM50AF_GC5005_resume,
    .driver        = {
...
static int __init FM50AF_GC5005_i2C_init(void)
{
...
static void __exit FM50AF_GC5005_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

module_init(FM50AF_GC5005_i2C_init);
module_exit(FM50AF_GC5005_i2C_exit);

MODULE_DESCRIPTION("FM50AF_GC5005 lens module driver");
