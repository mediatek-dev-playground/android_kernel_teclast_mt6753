...
#define AF_DRVNAME "DW9800WAF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x19
#define PLATFORM_DRIVER_NAME "lens_actuator_dw9800waf"
#define AF_DRIVER_CLASS_NAME "actuatordrv_dw9800waf"
...
inline static int getAFInfo(__user stDW9800WAF_MotorInfo * pstMotorInfo)
{
    stDW9800WAF_MotorInfo stMotorInfo;
    ...
    if(copy_to_user(pstMotorInfo , &stMotorInfo , sizeof(stDW9800WAF_MotorInfo)))
    {
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stDW9800WAF_MotorMETAInfo * pstMotorMETAInfo)
{
    stDW9800WAF_MotorMETAInfo stMotorMETAInfo;
    ...
    if(copy_to_user(pstMotorMETAInfo , &stMotorMETAInfo , sizeof(stDW9800WAF_MotorMETAInfo)))
    {
        LOG_INF("copy to user failed when getting motor information \n");
    }
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case DW9800WAFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stDW9800WAF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case DW9800WAFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stDW9800WAF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
        case DW9800WAFIOC_T_MOVETO :
            i4RetValue = moveAF(a_u4Param);
        break;

        case DW9800WAFIOC_T_SETINFPOS :
            i4RetValue = setAFInf(a_u4Param);
        break;

        case DW9800WAFIOC_T_SETMACROPOS :
...
static int __init DW9800WAF_i2C_init(void)
{
...
static void __exit DW9800WAF_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

module_init(DW9800WAF_i2C_init);
module_exit(DW9800WAF_i2C_exit);

MODULE_DESCRIPTION("DW9800WAF lens module driver");
