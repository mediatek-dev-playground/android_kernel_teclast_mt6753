...
#define AF_DRVNAME "FM50AF_GC8024"
#define I2C_SLAVE_ADDRESS        0x1a
#define I2C_REGISTER_ID            0x1a
#define PLATFORM_DRIVER_NAME "lens_actuator_fm50af_gc8024"
#define AF_DRIVER_CLASS_NAME "actuatordrv_fm50af_gc8024"
...
////////////////////////////////////////////////////////////////
static long FM50AF_GC8024_Ioctl(
...
//CAM_RESET
static int FM50AF_GC8024_Open(struct inode * a_pstInode, struct file * a_pstFile)
{
    LOG_INF("Start \n");
...
static int FM50AF_GC8024_Release(struct inode * a_pstInode, struct file * a_pstFile)
{
    LOG_INF("Start \n");
...
{
    .owner = THIS_MODULE,
    .open = FM50AF_GC8024_Open,
    .release = FM50AF_GC8024_Release,
    .unlocked_ioctl = FM50AF_GC8024_Ioctl,
#ifdef CONFIG_COMPAT
    .compat_ioctl = FM50AF_GC8024_Ioctl,
#endif
};
...
static int FM50AF_GC8024_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id);
static int FM50AF_GC8024_i2c_remove(struct i2c_client *client);
static const struct i2c_device_id AF_i2c_id[] = {{AF_DRVNAME, 0},{}};
static struct i2c_driver FM50AF_GC8024_i2c_driver = {
    .probe = FM50AF_GC8024_i2c_probe,
    .remove = FM50AF_GC8024_i2c_remove,
...
static int FM50AF_GC8024_probe(struct platform_device *pdev)
{
    return i2c_add_driver(&FM50AF_GC8024_i2c_driver);
}

static int FM50AF_GC8024_remove(struct platform_device *pdev)
{
    i2c_del_driver(&FM50AF_GC8024_i2c_driver);
    return 0;
}

static int FM50AF_GC8024_suspend(struct platform_device *pdev, pm_message_t mesg)
{
    return 0;
}

static int FM50AF_GC8024_resume(struct platform_device *pdev)
{
    return 0;
}
...
static struct platform_driver g_stAF_Driver = {
    .probe        = FM50AF_GC8024_probe,
    .remove    = FM50AF_GC8024_remove,
    .suspend    = FM50AF_GC8024_suspend,
    .resume    = FM50AF_GC8024_resume,
    .driver        = {
...
static int __init FM50AF_GC8024_i2C_init(void)
{
...
static void __exit FM50AF_GC8024_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

module_init(FM50AF_GC8024_i2C_init);
module_exit(FM50AF_GC8024_i2C_exit);

MODULE_DESCRIPTION("FM50AF_GC8024 lens module driver");
