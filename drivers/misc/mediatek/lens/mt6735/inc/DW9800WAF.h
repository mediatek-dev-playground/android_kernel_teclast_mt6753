...
#define DW9800WAFIOC_G_MOTORINFO _IOR(DW9800WAF_MAGIC, 0, stDW9800WAF_MotorInfo)

#define DW9800WAFIOC_T_MOVETO _IOW(DW9800WAF_MAGIC, 1, u32)

#define DW9800WAFIOC_T_SETINFPOS _IOW(DW9800WAF_MAGIC, 2, u32)

#define DW9800WAFIOC_T_SETMACROPOS _IOW(DW9800WAF_MAGIC, 3, u32)
#ifdef LensdrvCM3
#define DW9800WAFIOC_G_MOTORMETAINFO _IOR(DW9800WAF_MAGIC, 4, stDW9800WAF_MotorMETAInfo)
#endif
