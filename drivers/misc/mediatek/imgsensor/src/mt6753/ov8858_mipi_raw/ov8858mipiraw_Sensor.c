...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x3820, 0x06); //mirror
	write_cmos_sensor(0x3821, 0x61); //flip //0x67
...
//;XVCLK=24Mhz, SCLK=72Mhz, MIPI 720Mbps, DACCLK=180Mhz, Tline = 8.925926us
	...
	write_cmos_sensor(0x3814, 0x03);
	write_cmos_sensor(0x3821, 0x61); //flip mirror // 0x67
	write_cmos_sensor(0x382a, 0x03);
	write_cmos_sensor(0x3830, 0x08);
	write_cmos_sensor(0x3836, 0x02);
	write_cmos_sensor(0x3f08, 0x08);
...
static void capture_setting(kal_uint16 currefps)
{
	...
	//3.3 Raw 10bit 3264x2448 30fps 2lane 720M bps/lane
	//;XVCLK=24Mhz, SCLK=144Mhz, MIPI 720Mbps, DACCLK=360Mhz Tline = 8.981481us
	...
	write_cmos_sensor(0x3821, 0x40); // flip mirror  //0x46 
