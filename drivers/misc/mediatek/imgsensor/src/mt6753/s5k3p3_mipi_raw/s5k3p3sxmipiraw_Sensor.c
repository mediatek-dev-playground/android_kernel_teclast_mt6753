...
{{4104, 3062,	  0,	0, 4104, 3062, 2052,  1524, 0000, 0000, 2052,  1524,	  38,	14, 2000, 1500}, // Preview
 { 4104, 3062,	  0,	0, 4104, 3062, 4104,  3062, 0000, 0000, 4104,  3062,	  74,	40, 4000, 3000}, // capture
 { 4104, 3062,	  0,	0, 4104, 3062, 4104,  3062, 0000, 0000, 4104,  3062,	  74,	40, 4000, 3000}, // video
 { 4104, 3062,	  0,	0, 4104, 3062, 2100,  1098, 0000, 0000, 2100,  1098,  38, 14, 1920, 1080}, //hight speed video
  {4104, 3062,	  0,	0, 4104, 3062, 2052,  1524, 0000, 0000, 2052,  1524,	  38,	14, 2000, 1500}};// slim video
...
static SET_PD_BLOCK_INFO_T imgsensor_pd_info =
{
    ...
    .i4SubBlkW  =16,
    .i4SubBlkH  =16,
.i4PosL = {{16,19},{68,19},{32,23},{52,23},{20,39},{64,39},{36,43},{48,43},{36,51},{48,51},{20,55},{64,55},{32,71},{52,71},{16,75},{68,75}},    
.i4PosR = {{16,23},{68,23},{32,27},{52,27},{20,35},{64,35},{36,39},{48,39},{36,55},{48,55},{20,59},{64,59},{32,67},{52,67},{16,71},{68,71}},
};


#define MIPI_MaxGainIndex 187
...
write_cmos_sensor(0x0348,0x1207);
...
write_cmos_sensor(0x0136,0x1800);
write_cmos_sensor(0x0304,0x0006);
write_cmos_sensor(0x0306,0x008D);
write_cmos_sensor(0x0302,0x0001);
write_cmos_sensor(0x0300,0x0004);
write_cmos_sensor(0x030C,0x0004);
write_cmos_sensor(0x030E,0x0037);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		spin_unlock(&imgsensor_drv_lock);
		do {
			#if 0 //Jane add for read version
			LOG_INF("read_0x0002=0x%x\n",read_cmos_sensor_8(0x0002));
			#endif
			*sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001));
			...
			if (*sensor_id ==imgsensor_info.sensor_id) {
				...
				#if 1
				/*
					[Jane] if do real i2c read in cam_cal,
					the i2c0 bus will busy and wrong, both bus speed is different, and kernel will conflict with the cmd from userspace .

					this modification will increase search time, but it will decrease first bright on camera.
				*/
				print_3p3_eeprom_info();
				LOG_INF("find 3p3, prepare lsc, awb and af data\n");
				if ((1!=prepare_3p3_lsc_eeprom()) || (1!=prepare_3p3_awb_eeprom()) || (1!=prepare_3p3_af_eeprom())) {
					LOG_ERR("!!!###!!! fail to prepare lsc, awb and af eeprom\n");
				}
...
static kal_uint32 open(void)
{
	...
	LOG_INF("PLATFORM:MT6753,MIPI 4LANE\n");
...
#if 0 //Jane add for read version
	for(i=0;i<20;i++) {
		LOG_INF("%d:read_0x0005=0x%x\n",i,read_cmos_sensor_8(0x0005));
		mdelay(2);
	}
#endif
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	switch (feature_id) {
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:	
			...
			read_3p3_pdaf_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
			break;			
