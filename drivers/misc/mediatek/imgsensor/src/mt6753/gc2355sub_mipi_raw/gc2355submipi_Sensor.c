...
#include "gc2355submipi_Sensor.h"
/****************************Modify Following Strings for Debug****************************/
#define PFX "GC2355sub_camera_sensor"
#define LOG_1 LOG_INF("GC2355sub,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC2355SUB_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
UINT32 GC2355SUB_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
