...
static imgsensor_info_struct imgsensor_info = {
    ...
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gr,	//Gr,//Gb   //add by lijin 2015.4.8
...
#define OTP_SIZE  (1868+1)
#define LSC_ADDR  0x0020
u8 OTPData[OTP_SIZE]={0};
//u8 OTPData;
//EXPORT_SYMBOL(OTP_SIZE);
//EXPORT_SYMBOL(OTPData);
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	set_mirror_flip(IMAGE_HV_MIRROR);	//add by lijin 2015.4.8
    return ERROR_NONE;
}    /*    preview   */
