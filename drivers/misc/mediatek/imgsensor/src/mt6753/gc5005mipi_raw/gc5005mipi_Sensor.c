...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x17, MIRROR); //Don't Change Here!!! //0x55
	...
	write_cmos_sensor(0x92, STARTY); //Don't Change Here!!!   crop_win_y1[7:0] //0x03
	write_cmos_sensor(0x94, STARTX); //Don't Change Here!!!   crop_win_x1[7:0] //0x04
