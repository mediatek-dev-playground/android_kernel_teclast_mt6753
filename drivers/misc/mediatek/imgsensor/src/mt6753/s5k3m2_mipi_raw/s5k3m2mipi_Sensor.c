        ...
        do {
			...
			*sensor_id = read_cmos_sensor(0x6F12);
            ...
            if (*sensor_id == imgsensor_info.sensor_id) {               
				...
				*/
				LOG_INF("find 3m2, prepare lsc and af data\n");
				if ((1!=prepare_3m2_lsc_eeprom()) || (1!=prepare_3m2_af_eeprom())) {
					LOGE("!!!###!!! fail to prepare lsc and af eeprom\n");
				}
...
static kal_uint32 open(void)
{
	...
	#if 1
	//Jane add for 3m2 AWB
	if (update_3m2_awb_eeprom() == 1)
	{
		LOG_INF("AWB eeprom Update OK\n");
	}
	else
	{
		LOG_INF("AWB eeprom Update Fail\n");
	}
	#endif
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	switch (feature_id) {
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:	
			...
			read_3m2_pdaf_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
			break;			
